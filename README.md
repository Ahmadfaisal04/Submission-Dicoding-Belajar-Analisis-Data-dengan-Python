...
1. Clone repository ini ke komputer lokal Anda menggunakan perintah berikut:
   ...
   ```shell
   git clone https://github.com/Ahmadfaisal04/Submission-Dicoding-Belajar-Analisis-Data-dengan-Python.git
   ```
...
1. Masuk ke direktori proyek (Local):
    ...
    ```
    Atau bisa dengan kunjungi website ini [Project Data Analytics](https://bikesharing-ahmadfaisal.streamlit.app/)
